...
**Consequences.** The engine runs and is tested under plain Node (150 tests), with no emulator or React. New crops and systems are mostly data additions. The UI stays thin.
