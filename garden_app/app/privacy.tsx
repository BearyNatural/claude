...
const POINTS: { title: string; body: string }[] = [
  ...
  { title: 'What leaves your phone', body: 'When live weather is on, your approximate coordinates and timezone are sent to Open-Meteo (open-meteo.com) to get a forecast. If you use "Search more places online", your search text is sent to Open-Meteo\'s place search. If you use the optional garden map, the address you type is sent to OpenStreetMap\'s address search (Nominatim) when you press Find address, and satellite map images for the area on screen are loaded from Esri. These services receive the information needed to answer the request, like any website does (including your IP address). Nothing else is sent.' },
